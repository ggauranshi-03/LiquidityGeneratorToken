...
contract LiquidityGeneratorToken is IERC20, Ownable, BaseToken {
    ...
    // NEW ADDITION: Manual Burn Function
    /**
    ...
    function manualBurn(uint256 tAmount) public virtual onlyOwner {
        ...
        // Update timestamp before state changes (Reentrancy guard, though not critical here)
        ...
        // Emit events to notify off-chain listeners
        emit Transfer(owner(), address(0), tAmount);
        emit ManualBurn(owner(), tAmount);
    }
    // NEW ADDITIONS: Blacklist Management
